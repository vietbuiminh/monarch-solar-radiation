...
sunny_data = getData(2023, 6, 11, 1, 23)
cloudy_data = getData(2023, 6, 10, 1, 23)
rainny_data = getData(2023, 6, 18, 1, 23)
smoke_data = getData(2023, 6, 14, 1, 23)
...
resampled_data = merged_data.resample('6min').mean()
